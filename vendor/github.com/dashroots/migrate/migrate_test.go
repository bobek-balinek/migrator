...
import (
	...
	dStub "github.com/dashroots/migrate/database/stub"
	"github.com/dashroots/migrate/source"
	sStub "github.com/dashroots/migrate/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/dashroots/migrate/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/dashroots/migrate/source/stub"`
